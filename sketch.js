...
function setup() {
  ...
  ground = new Ground(500, 535, 1000, 20);

  hero = new Hero(400,800,200);
  rope = new Rope(hero.body, { x: 500, y: 50 });
  monster = new Monster(800,300,30);

  box1 = new Box(600, 100, 50, 50);
  box2 = new Box(600, 100, 50, 50);
  box3 = new Box(600, 100, 50, 50);
  box4 = new Box(600, 100, 50, 50);
  box5 = new Box(600, 50, 50, 50);
  box6 = new Box(600, 50, 50, 50);
  box7 = new Box(600, 50, 50, 50);
  box8 = new Box(600, 50, 50, 50);
  box9 = new Box(600, 50, 50, 50);

  box10 = new Box(550, 100, 50, 50);
  box11 = new Box(550, 100, 50, 50);
  box12 = new Box(550, 100, 50, 50);
  box13 = new Box(550, 100, 50, 50);
  box14 = new Box(550, 50, 50, 50);
  box15 = new Box(550, 50, 50, 50);
  box16 = new Box(550, 50, 50, 50);
  box17 = new Box(550, 50, 50, 50);
  box18 = new Box(550, 50, 50, 50);

  box19 = new Box(500, 100, 50, 50);
  box20 = new Box(500, 100, 50, 50);
  box21 = new Box(500, 100, 50, 50);
  box22 = new Box(500, 100, 50, 50);
  box23 = new Box(500, 100, 50, 50);
  box24 = new Box(500, 50, 50, 50);
  box25 = new Box(500, 50, 50, 50);
  box26 = new Box(500, 50, 50, 50);
  box27 = new Box(500, 50, 50, 50);
}
